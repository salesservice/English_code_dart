...
import 'package:flutter_isell_new/views/screens/items/cars_items/car_equipment.dart';
import 'package:flutter_isell_new/views/screens/items/cars_items/car_history.dart';
import 'package:flutter_isell_new/views/screens/items/cars_items/car_technical_data.dart';
import 'package:flutter_isell_new/views/screens/items/cars_items/essential_car_details.dart';
...
class ItemDetailsCar extends StatelessWidget {
  const ItemDetailsCar({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    int carpris = controller.itemsModel.itemPris!;
    int omregpris = controller.itemsModel.omregnetAvgift!;
    int totalpris = carpris + omregpris;
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Text(
                  "${controller.itemsModel.carMerke!} (${controller.itemsModel.carModell})",
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    int nonEmptyIndex =
                        findNonEmptyIndex(cardatavaiable, index);
                    if (nonEmptyIndex != -1) {
                      return Container(
                        padding: const EdgeInsets.only(left: 8),
                        width: cardatavaiable[nonEmptyIndex] ==
                                    "Elektrisitet + bensin" ||
                                cardatavaiable[nonEmptyIndex] ==
                                    "Elektrisitet + diesel" ||
                                cardatavaiable[nonEmptyIndex] ==
                                    "Gass + bensin" ||
                                cardatavaiable[nonEmptyIndex] == "Gass + diesel"
                            ? 140
                            : 110,
                        decoration: BoxDecoration(
                          border: Border.all(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              padding: const EdgeInsets.only(top: 5),
                              child: Text(
                                controller.cardata[nonEmptyIndex],
                                style: GoogleFonts.roboto(
                                  color: Myisellcolors.hvit70,
                                ),
                              ),
                            ...
                            Container(
                              ...
                              width: 27,
                              child: Image.asset(
                                controller.cardatapic[nonEmptyIndex],
                                color: Myisellcolors.hvit,
                              ),
                            ),
                            Container(
                              padding: EdgeInsets.only(
                                top: cardatavaiable[nonEmptyIndex] ==
                                        "Garasje/Parkering"
                                    ? 10
                                    : 8,
                              ),
                              child: Text(
                                cardatavaiable[nonEmptyIndex],
                                style: GoogleFonts.roboto(
                                  fontSize: cardatavaiable[nonEmptyIndex] ==
                                          "Garasje/Parkering"
                                      ? 11
                                      : 13,
                                  color: Myisellcolors.hvit,
          ...
          Essensiellecardata(),
          const MyDivador(),
          controller.itemsModel.fargeBeskrivelse!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(
                    ...
                    Container(
                      ...
                      child: Text(
                        controller.itemsModel.fargeBeskrivelse!,
                        style: GoogleFonts.roboto(
                            color: Myisellcolors.hvit,
                            fontSize: 15,
                            fontWeight: FontWeight.w500),
          ...
          TekniskData(),
          controller.itemsModel.salgLeie == "Til salgs"
              ? Column(
                  children: [
                    controller.itemsModel.carTrimmet == "Nei" &&
                            controller.itemsModel.whyTrimmet!.isNotEmpty
                        ? Container(
                            padding: const EdgeInsets.only(
                                left: 10, right: 10, bottom: 10),
                            child: Text(
                              controller.itemsModel.whyTrimmet!,
                              style: GoogleFonts.roboto(
                                color: Myisellcolors.hvit,
                                fontSize: 15,
                              ),
              ...
              : const SizedBox(),
          controller.itemsModel.salgLeie == "Til salgs" &&
                  controller.itemsModel.carFeil!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(
                    ...
                    controller.itemsModel.carFeil == "Ja" &&
                            controller.itemsModel.hvaFeil!.isNotEmpty
                        ? Container(
                            padding: const EdgeInsets.only(
                                left: 10, right: 10, top: 10, bottom: 10),
                            child: Text(
                              controller.itemsModel.hvaFeil!,
                              style: GoogleFonts.roboto(
                                color: Myisellcolors.hvit,
                                fontSize: 15,
                              ),
              ...
              : const SizedBox(),
          controller.itemsModel.salgLeie == "Til salgs" &&
                  controller.itemsModel.carReparasjon!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(
                        ...
                        children: [
                          ...
                          Container(
                            padding: const EdgeInsets.only(
                                right: 10, top: 15, bottom: 15),
                            child: Text(
                              controller.itemsModel.carReparasjon!,
                              style: GoogleFonts.roboto(
                                color: Myisellcolors.hvit,
                                fontSize: 16,
                              ),
                    ...
                    controller.itemsModel.carReparasjon == "Ja" &&
                            controller.itemsModel.hvaReparasjon!.isNotEmpty
                        ? Container(
                            padding: const EdgeInsets.only(
                                left: 10, right: 10, top: 10, bottom: 10),
                            child: Text(
                              controller.itemsModel.hvaReparasjon!,
                              style: GoogleFonts.roboto(
                                color: Myisellcolors.hvit,
                                fontSize: 15,
                              ),
              ...
              : const SizedBox(),
          controller.itemsModel.salgLeie == "Til salgs" &&
                  controller.itemsModel.carGjeld!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(
                        ...
                        children: [
                          ...
                          Container(
                            padding: const EdgeInsets.only(
                                right: 10, top: 15, bottom: 15),
                            child: Text(
                              controller.itemsModel.carGjeld!,
                              style: GoogleFonts.roboto(
                                color: Myisellcolors.hvit,
                                fontSize: 16,
                              ),
                    ...
                    controller.itemsModel.carGjeld == "Ja" &&
                            controller.itemsModel.hvaGjeld!.isNotEmpty
                        ? Container(
                            padding: const EdgeInsets.only(
                                left: 10, right: 10, top: 10),
                            child: Text(
                              controller.itemsModel.hvaGjeld!,
                              style: GoogleFonts.roboto(
                                color: Myisellcolors.hvit,
                                fontSize: 15,
                              ),
          ...
          const MyDivador(),
          controller.itemsModel.carBeskrivelse!.isNotEmpty
              ? CustomClickableRow(
                  name: "Beskrivelse",
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              controller.itemsModel.carBeskrivelse!,
                              style: GoogleFonts.roboto(
          ...
          controller.itemsModel.carBeskrivelse!.isNotEmpty
              ? const MyDivador()
              : const SizedBox(),
          controller.itemsModel.linkVideo!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(
                    ...
                    Container(
                      ...
                      child: Text(
                        "${controller.itemsModel.linkVideo}",
                        maxLines: 10,
                        style: GoogleFonts.roboto(
                          color: Myisellcolors.hvit,
                          fontSize: 15,
              ...
              : const SizedBox(),
          controller.itemsModel.carGirbetegnelse!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(
                    ...
                    Container(
                      ...
                      child: Text(
                        "${controller.itemsModel.carGirbetegnelse}",
                        maxLines: 10,
                        style: GoogleFonts.roboto(
                          color: Myisellcolors.hvit,
                          fontSize: 15,
              ...
              : const SizedBox(),
          controller.itemsModel.carHjuledriftbetegnese!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(
                    ...
                    Container(
                      padding:
                          const EdgeInsets.only(left: 10, bottom: 5, right: 10),
                      child: Text(
                        "${controller.itemsModel.carHjuledriftbetegnese}",
                        maxLines: 10,
                        style: GoogleFonts.roboto(
                          color: Myisellcolors.hvit,
                          fontSize: 15,
