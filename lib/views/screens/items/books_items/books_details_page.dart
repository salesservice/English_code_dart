...
import 'package:flutter_isell_new/views/screens/items/books_items/essential_books_details.dart';
...
class ItemDetailsBok extends StatelessWidget {
  const ItemDetailsBok({super.key});
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          BokdataList(),
          const MyDivador(),
          controller.itemsModel.bokBeskrivelse!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomClickableRow(
                          ...
                          Expanded(
                            child: SingleChildScrollView(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  controller.itemsModel.bokBeskrivelse!,
