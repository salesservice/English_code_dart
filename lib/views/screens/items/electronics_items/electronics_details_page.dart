...
import 'package:flutter_isell_new/views/screens/items/electronics_items/essential_electronics_details.dart';
...
class ItemDetailsElektronikk extends StatelessWidget {
  const ItemDetailsElektronikk({super.key});
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ElektronikkdataList(),
          const MyDivador(),
          controller.itemsModel.elektronikkBeskrivelse!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomClickableRow(
                          ...
                          Expanded(
                            child: SingleChildScrollView(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  controller.itemsModel.elektronikkBeskrivelse!,
