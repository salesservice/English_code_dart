...
import 'package:flutter_isell_new/views/screens/items/furniture_items/essential_furniture_details.dart';
...
class ItemDetailsMobler extends StatelessWidget {
  const ItemDetailsMobler({super.key});
    ...
    return Scaffold(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    controller.toggleFavorite(
                        controller, itemDetailsControllerImp);
                  },
                  icon: Icon(
      ...
      body: ListView(
        children: [
          ...
          MoblerdataList(),
          const MyDivador(),
          itemDetailsControllerImp.itemsModel.moblerBeskrivelse!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomClickableRow(
