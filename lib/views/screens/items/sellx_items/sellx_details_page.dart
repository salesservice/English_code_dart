...
import 'package:flutter_isell_new/views/screens/items/sellx_items/essential_sellx_deatails.dart';
...
class ItemDetailsSellx extends StatelessWidget {
  const ItemDetailsSellx({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    //     currentPage = newPage;
    //     // Update the counter when the page changes
    //     print(
    //         "Page changed to: ${currentPage + 1}/${itemDetailsControllerImp.itemsModel.itemIamge?.split(',')?.length}");
    //   }
    // });
    ...
    return Scaffold(
            ...
            child: GetBuilder<FavoritController>(
              builder: (controller) => Container(
                ...
                child: IconButton(
                  ...
                  onPressed: () {
                    favoritController.toggleFavorite(
                        favoritController, itemDetailsControllerImp);
                  },
                  icon: Icon(
      ...
      body: ListView(
        children: [
          ...
          //       decoration: BoxDecoration(
          //         color: Myisellcolors.picbg,
          //         border: Border.all(color: Myisellcolors.picbg, width: 0.5),
          //       ),
          //       child: Hero(
          //           transitionOnUserGestures: true,
          //           tag: "${itemDetailsControllerImp.itemsModel.itemId}",
          //           child: PageView.builder(
          //             itemCount: itemDetailsControllerImp.itemsModel.itemIamge
          //                     ?.split(',')
          //                     ?.length ??
          ...
          SellxdataList(),
          const MyDivador(),
          itemDetailsControllerImp.itemsModel.sellxBeskrivelse!.isNotEmpty
              ? Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomClickableRow(
                      name:
                          "Beskrivelse av ${itemDetailsControllerImp.itemsModel.itemName}",
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Container(
...
// PageView.builder(
                    ...
                    //       String myImg =
                    //           "${AppLink.imageitems}/${itemDetailsControllerImp.itemsModel.itemIamge!}";
                    //       return PhotoViewGalleryPageOptions(
                    //         //disableGestures: true,
                    //         // initialScale: 0.5,
                    //         imageProvider: NetworkImage(
