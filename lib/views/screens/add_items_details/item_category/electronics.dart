...
import 'package:flutter_isell_new/controller/add_items/electronics_items_controller.dart';
...
class ElektronikkAnnonse extends StatelessWidget {
  const ElektronikkAnnonse({super.key});

  @override
  Widget build(BuildContext context) {
    List<String> items = ["Ny", "Brukt"];
    AddElektronikkAnnonseController addElektronikkAnnonseController =
        Get.put(AddElektronikkAnnonseController());
    addElektronikkAnnonseController.VelgAnnonseType("Selge");

    return Form(
      key: addElektronikkAnnonseController.gkElektronikkannonse,
      child: Scaffold(
        ...
        body: GetBuilder<AddElektronikkAnnonseController>(
              ...
              children: [
                ...
                Container(
                  ...
                  child: IsellButtons(
                      ...
                      onPresset: () {
                        controller.addElektronikkAnnonseData();
                      },
