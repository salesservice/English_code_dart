...
import 'package:flutter_isell_new/controller/add_items/furniture_items_controller.dart';
...
class MoblerAnnonse extends StatelessWidget {
  const MoblerAnnonse({super.key});

  @override
  Widget build(BuildContext context) {
    List<String> items = ["Ny", "Brukt"];
    AddMoblerAnnonseController addMoblerAnnonseController =
        Get.put(AddMoblerAnnonseController());
    addMoblerAnnonseController.VelgAnnonseType("Selge");

    return Form(
      key: addMoblerAnnonseController.gkMoblerannonse,
      child: Scaffold(
        ...
        body: GetBuilder<AddMoblerAnnonseController>(
            ...
            widget: ListView(
              children: [
                    ...
                    Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          //   height: controller.file.isEmpty ? 100 : 200,
                          //   child: controller.file.isEmpty
                          //       ? InkWell(
                          //           onTap: () {
                          //             controller.chooseImageGalery();
                          //           },
                          //           child: SvgPicture.asset(
                          //               width: 50, "assets/images/address.svg"))
                          //       : GridView.builder(
                          //           gridDelegate:
                ...
                IsellTextField(
                  ...
                  hinttxt:
                      "Skriv nøkkelord som er relatert til varen du selger",
                  hinttxtcolor: Myisellcolors.hvit70,
                  contentpadding: const EdgeInsets.fromLTRB(25, 20, 25, 35),
                  txtcolor: Myisellcolors.hvit70,
                  txttype: TextInputType.multiline,
                  onSav: (value) {},
                  height: 22,
                ...
                Container(
                  margin: const EdgeInsets.only(top: 6, left: 16.5, right: 12),
                  child: Text(
                    "Nøkkelord spiller en viktig rolle i å øke synligheten til annonsene dine når potensielle kunder bruker søkemotorer. For eksempel kan nøkkelord som 'Sofaer', 'Tepper', og 'Spisebord' bidra til å øke sannsynligheten for at din annonse blir sett.",
                    style: GoogleFonts.roboto(
                ...
                Container(
                  ...
                  child: IsellButtons(
                      ...
                      onPresset: () {
                        controller.addMoblerAnnonseData();
                      },
