...
import 'package:flutter_isell_new/controller/add_items/job_items_controller.dart';
...
class JobbAnnonse extends StatelessWidget {
  const JobbAnnonse({super.key});

  @override
  Widget build(BuildContext context) {
    List<String> erdethjemmekontor = ["Ja", "Nei"];
    AddJobbAnnonseController addJobbAnnonseController =
        Get.put(AddJobbAnnonseController());
    addJobbAnnonseController.VelgAnnonseType("Heltid");

    return Form(
      key: addJobbAnnonseController.gkJobbannonse,
      child: Scaffold(
        ...
        body: GetBuilder<AddJobbAnnonseController>(
                ...
                children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              controller.VelgAnnonseType("Heltid");
                            },
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: controller.jobbtype == "Heltid"
                                        ? Myisellcolors.hoved
                          ...
                          InkWell(
                            onTap: () {
                              controller.VelgAnnonseType("Deltid");
                            },
                            child: Container(
                              height: Get.height / 21,
                              width: Get.width / 2.3,
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(5),
                                border: Border.all(
                                    color: controller.jobbtype == "Deltid"
                                        ? Myisellcolors.hoved
                                        : Myisellcolors.hvit70),
                              ),
                              child: Center(
                  ...
                  IsellTextField(
                    ...
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    fontsizehinttext: 13.5,
                    con: controller.jobbfirma,
                    validater: (val) {
                      return validInput(val!, 0, 50, "");
                    },
                    hinttxt: "Skriv navnet til firmaet",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.name,
                  ...
                  IsellTextField(
                    ...
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    fontsizehinttext: 13.5,
                    con: controller.jobbstillingtitel,
                    validater: (val) {
                      return validInput(val!, 0, 50, "");
                    },
                    hinttxt: "Stillingstittel",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.name,
                  ...
                  IsellTextField(
                    ...
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    fontsizehinttext: 13.5,
                    con: controller.jobbfrist,
                    validater: (val) {
                      return validInput(val!, 0, 50, "");
                    },
                    hinttxt: "For eks. Snarest, forløpende, 12.03.2023...",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                  ...
                  IsellTextField(
                    ...
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    fontsizehinttext: 13.5,
                    con: controller.jobbansettelsesform,
                    validater: (val) {
                      return validInput(val!, 0, 50, "");
                    },
                    hinttxt: "Ansettelsesform",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.name,
                    ...
                    child: DropdownButtonHideUnderline(
                      child: ButtonTheme(
                        ...
                        child: DropdownButtonFormField(
                          ...
                          hint: const Text('Hjemmekontor?',
                              style: TextStyle(
                                  color: Myisellcolors.hvit70, fontSize: 13.5)),
                          items: erdethjemmekontor.map(
                            (e) {
                          ...
                          onChanged: (value) {
                            controller.hjemmekontor.value = value as String;
                            controller.jobbhjemmekontor!.text = value;
                          },
                        ),
                      ),
                    ),
                  ...
                  IsellTextField(
                    ...
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    fontsizehinttext: 13.5,
                    con: controller.jobbstillingsfunksjon,
                    // validater: (val) {
                    //   return validInput(val!, 0, 50, "");
                    // },
                    hinttxt: "Stillingsfunksjon",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.text,
                  ...
                  IsellTextField(
                    con: controller.jobbbeskrivelse,
                    maxlines: null,
                    focusNode: FocusNode(),
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    ...
                    // },
                    hinttxt: "Skriv en beskrivelse av stillingen",
                    hinttxtcolor: Myisellcolors.hvit70,
                  ...
                  IsellTextField(
                    ...
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    fontsizehinttext: 13.5,
                    con: controller.arbeidsprak,
                    // validater: (val) {
                    //   return validInput(val!, 0, 50, "");
                    // },
                    hinttxt: "Arbeidsspråk",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.text,
                  ...
                  IsellTextField(
                    con: controller.jobbomarbeidsgiver,
                    maxlines: null,
                    focusNode: FocusNode(),
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    ...
                    //   return validInput(val!, 0, 1000000, "");
                    // },
                    hinttxt: "Skriv litt om arbeidsgiveren",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 50),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.multiline,
                  ...
                  IsellTextField(
                    con: controller.jobbantllstillinger,
                    maxlines: null,
                    focusNode: FocusNode(),
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    ...
                    //   return validInput(val!, 0, 50, "");
                    // },
                    hinttxt: "Antall ledige stillinger",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                  ...
                  IsellTextField(
                    ...
                    //   return validInput(val!, 0, 50, "");
                    // },
                    hinttxt: "Legg til linken til hjemmeside",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.number,
                  ...
                  IsellTextField(
                    ...
                    hinttxt: "Navnet til kontakpersonen ang. stillingen",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.name,
                  ...
                  IsellTextField(
                    ...
                    hinttxt: "Nummer å bli kontatet på ang. stillingen",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.number,
                  ...
                  IsellTextField(
                    con: controller.stillingkontaktperon1,
                    maxlines: null,
                    focusNode: FocusNode(),
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                    ...
                    hinttxt: "Hvilken stilling har kontaktpersonen",
                    hinttxtcolor: Myisellcolors.hvit70,
                    contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                    txtcolor: Myisellcolors.hvit70,
                    txttype: TextInputType.name,
                  ...
                  IsellTextField(
                    con: controller.jobbkontaktperson,
                    maxlines: null,
                    focusNode: FocusNode(),
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                  ...
                  IsellTextField(
                    con: controller.jobbtelefonkontaktpers,
                    maxlines: null,
                    focusNode: FocusNode(),
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                  ...
                  IsellTextField(
                    con: controller.stillingkontaktperon2,
                    maxlines: null,
                    focusNode: FocusNode(),
                    paddingcontainer:
                        const EdgeInsets.only(left: 16, right: 16, top: 25),
                  ...
                  Container(
                    ...
                    child: IsellButtons(
                        ...
                        name: "Legg til ny annonsem",
                        onPresset: () {
                          controller.addJobbAnnonseData();
                        },
