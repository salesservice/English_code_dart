...
import 'package:flutter_isell_new/controller/add_items/bicycles_items_controller.dart';
...
class SykkelAnnonse extends StatelessWidget {
  const SykkelAnnonse({super.key});

  @override
  Widget build(BuildContext context) {
    List<String> items = ["Ny", "Brukt"];

    List<String> sykkeltypene = [
      "BMX",
      "Cyclocross/gravel",
      "Elektriske",
      "Fulldamper",
    ...
    AddSyklerAnnonseController addSyklerAnnonseController =
        Get.put(AddSyklerAnnonseController());
    addSyklerAnnonseController.VelgAnnonseType("Selge");

    return Form(
      key: addSyklerAnnonseController.gkSyklerannonse,
      child: Scaffold(
        ...
        body: GetBuilder<AddSyklerAnnonseController>(
            ...
            widget: ListView(
              children: [
                  ...
                  child: DropdownButtonHideUnderline(
                    child: ButtonTheme(
                      ...
                      child: DropdownButtonFormField(
                        ...
                        validator: (value) {
                          if (value == null) {
                            return 'Du må velge sykkeltypen';
                          } else {
                            return null;
                          }
                        },
                        ...
                        hint: const Text('Velg sykkeltype',
                            style: TextStyle(color: Myisellcolors.hvit70)),
                        items: sykkeltypene.map(
                          (e) {
                        ...
                        onChanged: (value) {
                          controller.sykkeltypen.value = value as String;
                          controller.sykkeltype!.text = value;
                        },
                      ),
                    ),
                  ),
                ...
                IsellTextField(
                  ...
                  fontsizehinttext: 14.5,
                  validater: (val) {},
                  hinttxt: "Hvilken merke har sykkelen",
                  hinttxtcolor: Myisellcolors.hvit70,
                  contentpadding: const EdgeInsets.fromLTRB(30, 20, 30, 20),
                  txtcolor: Myisellcolors.hvit70,
                  txttype: TextInputType.name,
                  ...
                  child: DropdownButtonHideUnderline(
                    child: ButtonTheme(
                      ...
                      child: DropdownButtonFormField(
                        ...
                        onChanged: (value) {
                          controller.tilstand.value = value as String;
                ...
                IsellTextField(
                  con: controller.sykkelbeskrivelse,
                  maxlines: null,
                  focusNode: FocusNode(),
                  paddingcontainer:
                      const EdgeInsets.only(left: 16, right: 16, top: 25),
                ...
                Container(
                  ...
                  child: IsellButtons(
                      ...
                      onPresset: () {
                        controller.addSyklerAnnonseData();
                      },
