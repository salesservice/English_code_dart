...
import 'package:flutter_isell_new/controller/add_items/sellx_items_controller.dart';
...
class SellxAnnonse extends StatelessWidget {
  const SellxAnnonse({super.key});

  @override
  Widget build(BuildContext context) {
    List<String> items = ["Ny", "Brukt"];
    AddSellxAnnonseController addSellxAnnonseController =
        Get.put(AddSellxAnnonseController());
    addSellxAnnonseController.VelgAnnonseType("Selge");

    return Form(
      key: addSellxAnnonseController.gksellxannonse,
      child: Scaffold(
        ...
        body: GetBuilder<AddSellxAnnonseController>(
            ...
            widget: ListView(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "Nøkkelord spiller en viktig rolle i å øke synligheten til annonsene dine når potensielle kunder bruker søkemotorer. For eksempel kan nøkkelord som 'Rolex', 'Dess', og 'Playstation' bidra til å øke sannsynligheten for at din annonse blir sett.",
                    style: GoogleFonts.roboto(
                ...
                Container(
                  ...
                  child: IsellButtons(
                      ...
                      onPresset: () {
                        controller.addSellxAnnonseData();
                      },
